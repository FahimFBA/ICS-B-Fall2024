...
const config = {
  title: 'Introduction to Computer Systems (Section - B)',
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/FahimFBA/ICS-B-Fall2024',
            label: 'GitHub',
            position: 'right',
          },
        ],
