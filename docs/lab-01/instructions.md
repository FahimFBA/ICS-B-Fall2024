...
Make sure to write the mail subject in this way: `(ICS-B) .......subject.....`
...
A group chat has been created and till now, we have 2 CRs (Class Representative) named **Abdullah Bin Lokman**, and **Jobayar Islam**.
